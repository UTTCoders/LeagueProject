...
<div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:90px;margin-bottom:40px;">
  <div class="col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-0 col-xs-12" id="manageMenu">
      <a class="manageMenuHeader col-md-12 col-sm-12 col-xs-12">Seasons...</a>
      ...
      <a href="/admin/seasons/delete" class="manageMenuItem col-md-12 col-sm-12 col-xs-12">Delete</a>
  </div>
  <div class="col-md-7 col-md-offset-1 no-padding col-xs-12 blackWell">
    <div class="header">
      <h4>Programme a season</h4>
    </div>
    <div class="col-xs-12" style="margin-bottom:15px;">
      <div class="" style="display:block;margin:auto;width:100px;background:transparent;text-align:center;border-radius:5px;border:1px dashed #888;cursor:pointer;">
