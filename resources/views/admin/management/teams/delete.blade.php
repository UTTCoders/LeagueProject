    ...
    <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
      @foreach(App\League\Team::get() as $team)
        <form class="" id="addForm" action="/addTeam" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="col-md-3 col-xs-12 col-sm-4 cardParent" name="{{$team->id}}" style="padding:15px; ;overflow: hidden;">
            <div class="col-md-12 col-sm-12 col-xs-12 no-padding" style="height:100%;overflow: hidden;box-shadow: 0px 0px 3px 0px #000;">
              <div class="coachCard col-md-12 col-sm-12 col-xs-12 no-padding" id="{{$team->id}}">
                  <img src="{{asset('storage/'.$team->logo)}}" alt="" width="120%" class=""/ name="{{$team->id}}">
